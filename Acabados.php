...
<head>
	<meta charset="utf-8">
	<title>DUO Impresiones | Acabados</title>
...
<div id="page-loader" class="fade in"><span class="spinner"></span></div>
				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown navbar-user">
						<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
							...
							<span class="hidden-xs" id="NombreUsuario"><?php echo $_SESSION['Nombre']; ?></span> <b class="caret"></b>
						</a>
    ...
    <div class="panel panel-success" data-sortable-id="table-basic-2">
        <div class="panel-heading">
            ...
            <h4 class="panel-title">Pedidos pendientes<strong>  Acabados</strong> </h4>
        </div>
        <div class="panel-body">
            ...
            <div class="table-responsive" id="tab">
                <table id="data-table" class="table table-hover table-bordered nowrap" id="TablaAcabados" width="100%" name="TablaAcabados">
                    <thead>
                        <tr>
                            <th>Folio pedido</th>
...
<style type="text/css">
	...
	<script src="assets/jsduo/ConsultaAcabados.js"></script>
