          ...
          console.log(pedidos);
            ...
            var timeline='<li>'+
                            '<div class="timeline-time">'+
                                '<span class="date">Nivel de Prioridad:</span>'+//Dia en el que estara listo
                            ...
                            '</div>'+
                                '<div class="timeline-body">'+
                                    ...
                                    '</div>'+
                                    '<div class="timeline-footer">El proceso actual esta: '+ pedidos.StatusPedido +//Pie del timeline
                                    '</div>'+
                            '</li>';
