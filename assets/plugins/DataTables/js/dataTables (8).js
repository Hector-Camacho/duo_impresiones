...
TableTools.BUTTONS = {
	...
	"print": $.extend( {}, TableTools.buttonBase, {
		"sInfo": "<h6>Vista de impresión</h6><p>Utiliza la funcion de impresión (CTRL + P) "+
		  "para imprimir esta tabla.</p>",
		"sMessage": null,
		"bShowAll": true,
	...
	"ajax": $.extend( {}, TableTools.buttonBase, {
		...
		"fnClick": function( nButton, oConfig ) {
			...
			$.ajax( {
				...
				"cache": false,
				"error": function () {
					alert( "Error detectado al enviar datos de la tabla de servidor" );
				}
			} );
		},
